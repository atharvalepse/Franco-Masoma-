import { ReserveCTA, Section, SectionHeader, StatsRow } from "@/components/Layout";

const categories = [
  { n: "01", title: "Ties & Neckwear", body: "Silk and textured neckwear designed for leadership and ceremony." },
  { n: "02", title: "Pocket Squares", body: "Refined accents that define balance and coordination." },
  { n: "03", title: "Cufflinks & Studs", body: "Precision-crafted details for formal expression." },
  { n: "04", title: "Scarves & Wraps", body: "Seasonal layering for warmth and elegance." },
  { n: "05", title: "Leather Goods", body: "Italian leather essentials designed for longevity." },
  { n: "06", title: "Watches", body: "Curated timepieces shaped for proportion and presence." },
  { n: "07", title: "Sunglasses", body: "Refined eyewear for modern sophistication." },
  { n: "08", title: "Hats", body: "Heritage-inspired accessories for considered occasions." },
];
